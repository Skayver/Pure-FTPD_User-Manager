<?php
	...
	}else
	{
		...
		$default_dir              = "/";
		$default_status           = "1";
		$default_quotafiles       = "2000";
		$default_quotasize        = "15000";
		$default_ulbandwidth      = "0";
		$default_dlbandwidth      = "0";
		$default_dlratio          = "0";
		$default_ulratio          = "0";
		$default_ipaddress        = "*";
		$default_comment          = "";
		...
		if(isset($_POST['save']))
		{
			...
			if (strlen($_POST['password_box']) == 0 || ($_POST['password_box'] == "*****"))
				$empty_password = 1;
		...
		echo ("<meta name=\"description\" content=\"The ‘FTP User manager’ is a software project from Machiel Mastenbroek,");
		...
		echo ("<input type=\"text\" name=\"confirm_password_box\" size=\"20\" maxlength=\"64\" value=\"$confirm_password\">\n");
		echo ("</td>\n");
		echo ("</tr>\n");
